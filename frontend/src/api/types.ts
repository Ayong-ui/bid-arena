...
export type CreateAgentProxyRequest = components['schemas']['CreateAgentProxyRequest']
export type AgentProxySummary = components['schemas']['AgentProxySummary']
export type AgentProxyPage = components['schemas']['AgentProxyPage']
